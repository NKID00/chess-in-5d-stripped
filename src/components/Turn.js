...
export default class Turn extends React.Component {
  ...
  draw() {
    ...
    if(this.props.active || this.props.present) {
      ...
      (this.props.fade ? 0.5 : 1), (this.props.flip ? 0 : 1));
    }
    else {
      graphics.lineStyle(30, this.props.palette.inactiveBoardOutline, (this.props.fade ? 0.5 : 1), (this.props.flip ? 0 : 1));
    }
    if(
      ...
      graphics.lineStyle(this.props.present ? 70 : 50, this.props.palette.checkBoardOutline, (this.props.fade ? 0.5 : 1), (this.props.flip ? 0 : 1));
    }
    ...
    for(var i = 0;i < 8;i++) {
      for(var j = 0;j < 8;j++) {
        if(((i + j) % 2 === 0 && !this.props.flip) || ((i + j) % 2 !== 0 && this.props.flip)) {
          graphics.beginFill(this.props.palette.whiteSquare, (this.props.fade ? 0.5 : 1));
          graphics.drawRect(x + (i * 100), y + (j * 100) * (this.props.flip ? -1 : 1), 100, 100 * (this.props.flip ? -1 : 1));
          graphics.endFill();
        }
        else {
          graphics.beginFill(this.props.palette.blackSquare, (this.props.fade ? 0.5 : 1));
          graphics.drawRect(x + (i * 100), y + (j * 100) * (this.props.flip ? -1 : 1), 100, 100 * (this.props.flip ? -1 : 1));
          graphics.endFill();
        }
      }
